  ...
  return (
    <div className="search-container">
      <div className="search-row">
        ...
        >
          <option value="partial">Частичный поиск</option>
          <option value="exact">Точный поиск</option>
        </select>
      ...
      {results.map((product) => (
        <div key={product.id} className="search-result-card">
          ...
          <div className="product-meta">
            <div className="product-stock">Количество: {product.stock} шт.</div>
          ...
          {product.discount > 0 && (
            <span className="badge discount-badge">Скидка {product.discount}%</span>
          )}
        </div>
      ))}
    </div>
...
const App = () => {
  ...
  return (
    <div className="app">
      ...
      {isSearching ? (
        <>
          <h2 className="search-results-title">Результаты поиска</h2>
